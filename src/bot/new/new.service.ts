...
export class NewService{
    ...
    private async movePlayers(interaction: CommandInteraction, type: "FFA" | "Teamers"){
        let member: GuildMember = interaction.member as GuildMember;
        let guild: Guild = interaction.guild as Guild;
        let currentVoiceChannel: VoiceChannel | null = member.voice.channel as (VoiceChannel | null);
