...
export abstract class SplitInteractions {
    ...
    public async classic(
        ...
        @SlashOption("2й-капитан", { required: false, type: ApplicationCommandOptionType.User }) captain2: GuildMember | null = null,
        interaction: CommandInteraction
    ) { await this.splitService.classic(interaction, captain1, captain2); }
    ...
    public async double(
        ...
        @SlashOption("2й-капитан", { required: false, type: ApplicationCommandOptionType.User }) captain2: GuildMember | null = null,
        interaction: CommandInteraction
    ) { await this.splitService.double(interaction, captain1, captain2); }
    ...
    public async cwc(
        ...
        @SlashOption("2й-капитан", { required: false, type: ApplicationCommandOptionType.User }) captain2: GuildMember | null = null,
        interaction: CommandInteraction
    ) { await this.splitService.cwc(interaction, captain1, captain2); }
}
