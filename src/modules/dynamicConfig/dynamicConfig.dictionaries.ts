...
export const tagsMap: Map<string, string[]> = new Map<string, string[]>([
    ...
    ["DYNAMIC_CONFIG_SUBCATEGORY_GAME_FFA", [
        ...
        "DYNAMIC_CONFIG_SUBCATEGORY_GAME_FFA_CHATTING", "DYNAMIC_CONFIG_SUBCATEGORY_GAME_FFA_RATING",
    ...
    ["DYNAMIC_CONFIG_SUBCATEGORY_GAME_TEAMERS", [
        ...
        "DYNAMIC_CONFIG_SUBCATEGORY_GAME_TEAMERS_REMAPS", "DYNAMIC_CONFIG_SUBCATEGORY_GAME_TEAMERS_RATING",
